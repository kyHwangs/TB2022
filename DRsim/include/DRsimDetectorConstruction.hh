...
private:
  ...
  G4LogicalVolume* ModuleLogical[2];

  G4LogicalVolume* PMTGLogical[2];
  G4LogicalVolume* PMTcathLogical[2];
  G4LogicalVolume* PMTcellLogical[2];
  G4LogicalVolume* PMTfilterLogical[2];
  G4LogicalVolume* ReflectorMirrorLogical[2];

  vector<G4LogicalVolume*> fiberUnitIntersection[2];
  vector<G4LogicalVolume*> fiberCladIntersection[2];
  vector<G4LogicalVolume*> fiberCoreIntersection[2];
